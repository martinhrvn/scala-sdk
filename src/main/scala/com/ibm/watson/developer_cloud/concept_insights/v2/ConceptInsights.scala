...
object ConceptInsights {
    ...
    private[this] val idsLabel: String = "ids"
    private[this] val limitLabel: String = "limit"
    private[this] val levelLabel: String = "level"
    private[this] val cursorLabel: String = "cursor"
    private[this] val conceptFieldsLabel: String = "concept_fields"
}
